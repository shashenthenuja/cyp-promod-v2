main()
{
	...
	// website
	setDvar( "promod_hud_website", "CYP Promod" ); // (avoid "//" here)
	...
	setDvar( "promod_mc_message_1", "^2Mod By ^3Shashen Thenuja" );
	setDvar( "promod_mc_message_2", "^2Powered By ^3Cypher Technologies" );
